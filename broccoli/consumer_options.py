...
class OptionParserHandler(object):
    ...
    def get_option_parser(self):
        ...
        add_group('Workers', (
            'By default broccoli uses a single worker thread. To specify a '
        ...
        add_group('Scheduler', (
            'By default Broccoli will run the scheduler once every second to check'
