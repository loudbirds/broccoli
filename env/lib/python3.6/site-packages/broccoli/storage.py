...
class BaseStorage(object):
    def __init__(self, name='broccoli', **storage_kwargs):
        self.name = name
...
class RedisStorage(BaseStorage):
    def __init__(self, name='Broccoli', blocking=False, read_timeout=1,
        ...
        self.queue_key = 'broccoli.redis.%s' % self.name
        self.schedule_key = 'broccoli.schedule.%s' % self.name
        self.result_key = 'broccoli.results.%s' % self.name
        self.error_key = 'broccoli.errors.%s' % self.name
